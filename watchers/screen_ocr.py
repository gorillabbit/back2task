...
class ScreenClassifier:
    ...
    def analyze_content(self, text: str) -> Dict[str, any]:
        ...
        unproductive_keywords = [
            ...
            'reddit', 'netflix', 'prime video', 'hulu', 'disney',
            'game', 'steam', 'epic games', 'twitch',
            'おすすめ動画', '再生', 'いいね', 'チャンネル登録',
            'trending', 'viral', 'meme'
        ]
        
        # 生産的キーワード
        productive_keywords = [
            'code', 'python', 'javascript', 'github', 'stackoverflow',
            'documentation', 'tutorial', 'programming', 'development',
            'プログラミング', 'コード', 'ドキュメント', 'エラー',
    ...
    if MSS_AVAILABLE and OCR_AVAILABLE:
        ...
        for i in range(3):
            ...
            if text:
                ...
                print(f"生産性判定: {analysis['productive']} (信頼度: {analysis['confidence']})")
